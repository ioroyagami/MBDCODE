###########################################################################
## Makefile generated for Simulink model 'InternalADC20190225'. 
## 
## Makefile     : InternalADC20190225.mk
## Generated on : Mon Feb 25 21:28:24 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/InternalADC20190225.out
...
PRODUCT_NAME              = InternalADC20190225
MAKEFILE                  = InternalADC20190225.mk
COMPUTER                  = PCWIN64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/InternalADC20190225.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/InternalADC20190225_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/src -IC:/TI/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1/include -IC:/TI/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~4/include -IC:/TI/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1 -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -DMODEL=InternalADC20190225 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DSTACK_SIZE=512 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DF28377D -DCPU1 -DBOOT_FROM_FLASH=1
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_IMPLIED = -DTID01EQ=0
DEFINES_SKIPFORSIL = -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=16 -DF2837X_REG_FORMAT -DMW_F2837XD -DSTACK_SIZE=512 -DRT -DF28377D -DCPU1 -DBOOT_FROM_FLASH=1
DEFINES_STANDARD = -DMODEL=InternalADC20190225 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_c28xx_board.obj InternalADC20190225.obj InternalADC20190225_data.obj MW_c28xx_adc.obj MW_c28xx_csl.obj MW_c28xx_pwm.obj MW_data.obj c2837xDBoard_Realtime_Support.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj profiler_Support.obj c2837xDSchedulerTimer0.obj
...
CFLAGS_SKIPFORSIL = -v28 --float_support=fpu32 -ml -DF28377D -DCPU1 -DBOOT_FROM_FLASH=1
...
CPPFLAGS_SKIPFORSIL = -v28 --float_support=fpu32 -ml -DF28377D -DCPU1 -DBOOT_FROM_FLASH=1
...
CPP_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define F28377D --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define F28377D --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define F28377D --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_fpu32.lib" --define F28377D --define CPU1 --define BOOT_FROM_FLASH=1 --define BOOT_USING_BL=0
...
%.obj : $(START_DIR)/InternalADC20190225_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/InternalADC20190225_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/InternalADC20190225_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/InternalADC20190225_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
